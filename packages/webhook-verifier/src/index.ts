 ...
 * signature verifier for CloudflareTest outbound webhook deliveries.
 *
...
/**
 * Compute the canonical CloudflareTest webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a CloudflareTest webhook delivery.
 *
