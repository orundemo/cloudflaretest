...
//   - CloudflareTestError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): CloudflareTest {
  return new CloudflareTest({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the CloudflareTest class", () => {
