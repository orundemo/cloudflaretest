// Typed error hierarchy for the CloudflareTest SDK.
//
...
// codes (forward compatibility) fall back to the generic `CloudflareTestError`
...
export interface CloudflareTestErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof CloudflareTestError`
 * still matches.
 */
export class CloudflareTestError extends Error {
  ...
  constructor(init: CloudflareTestErrorInit) {
    super(init.envelope.message);
    this.name = "CloudflareTestError";
...
export class BadRequestError extends CloudflareTestError {
  constructor(init: CloudflareTestErrorInit) {
    super(init);
...
export class UnauthenticatedError extends CloudflareTestError {
  constructor(init: CloudflareTestErrorInit) {
    super(init);
...
export class ForbiddenError extends CloudflareTestError {
  constructor(init: CloudflareTestErrorInit) {
    super(init);
...
export class NotFoundError extends CloudflareTestError {
  constructor(init: CloudflareTestErrorInit) {
    super(init);
...
export class ConflictError extends CloudflareTestError {
  constructor(init: CloudflareTestErrorInit) {
    super(init);
...
export class ValidationError extends CloudflareTestError {
...
export class PreconditionFailedError extends CloudflareTestError {
  constructor(init: CloudflareTestErrorInit) {
    super(init);
...
export class UnsupportedError extends CloudflareTestError {
  constructor(init: CloudflareTestErrorInit) {
    super(init);
...
export class InternalError extends CloudflareTestError {
  constructor(init: CloudflareTestErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends CloudflareTestErrorInit {
...
export class RateLimitError extends CloudflareTestError {
...
/**
 * Decode an HTTP `Response` into the appropriate `CloudflareTestError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `CloudflareTestError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new CloudflareTestError(init);
  }
}

function decodeRateLimit(
  init: CloudflareTestErrorInit,
  response: Response,
): RateLimitError {
