...
// `@saas/sdk` client class name (`CloudflareTest`) is intentionally NOT part of
...
export const CLI_BIN = "cloudflaretest";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Cloudflare Test";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.tester.dev";
