// `cloudflaretest webhook verify` — local cryptographic verification of a
// CloudflareTest outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `cloudflaretest login`.
