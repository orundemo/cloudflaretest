...
//   - `~/.config/cloudflaretest/credentials.json` (0600)
//   - `~/.config/cloudflaretest/config.json`     (0644)
//
// Override via `CLOUDFLARETEST_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/cloudflaretest` everywhere
